...
class Tree:
    ...
    SOIL_COLOUR = (64, 64, 64)  #soil colour - #404040 theme
    BOX_COLOUR = (200, 200, 200)

    BRANCH_COLOUR = ((248, 252), (248, 252), (248, 252))  #range of rgb values - #fcfcfc theme
    ...
    def draw_tree_base(self, trunk_width):
        ...
        self.window.set_char_instant(inx1, left_x - 2, ".", (64, 64, 64), True)
        self.window.set_char_instant(inx1, left_x - 1, "/", (64, 64, 64), True)
        self.window.set_char_instant(inx1, right_x + 1, "\\", (64, 64, 64), True)
        self.window.set_char_instant(inx1, right_x + 2, ".", (64, 64, 64), True)
    ...
    def draw(self):
        ...
        for _ in range(Leaves.NUM_LEAVES):
            ...
            for i in range(self.options.leaf_len):
                ...
                colour = (64, 64, 64)  #leaf colour - #404040 theme
